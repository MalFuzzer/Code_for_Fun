...
; view the output in the TD debugger
...
start:
	 mov ax, @data
	 mov ds, ax
	 mov dx, count - 1 ; assign the value of count variable (-1 beacuse index(0) + index(4) = 5) to to the dx register
